...
function OnLoad()
{
    ...
    {
        NETWORK_NAME = "WBN-MAIN";
        FillSelect("idCurNetwork", [{value:NETWORK_NAME, text:"WBN MAIN"}]);
...
LangMap["简体中文"] = {"WBN WALLET":"WBN 钱包", "Generate key":"生成私钥", "OK":"OK", "Cancel":"取消", "Edit":"编辑", "Save key":"保存私钥",
    ...
    "More info":"详情", "Public key":"公钥", "Tera Wallet Guide...":"WBN钱包创建指南", "==HELP-LINK==":"https://terafoundation.org/files/Tera-Wallet-cn.pdf",
};
